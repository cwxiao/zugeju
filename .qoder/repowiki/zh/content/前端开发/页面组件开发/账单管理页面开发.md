...
subgraph "后端层"
E[控制器<br/>ActivityController]
F[服务层<br/>ActivityExpenseService]
G[数据传输对象<br/>DTOs]
H[实体类<br/>ActivityExpenseEntity]
end
subgraph "数据库层"
I[活动费用表<br/>activity_expenses]
J[活动成员表<br/>activity_members]
K[活动主表<br/>activities]
end
A --> E
B --> A
C --> A
