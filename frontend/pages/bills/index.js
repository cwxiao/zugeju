...
Page({
  data: {
    ...
    // 消费项目预设
    expenseCategories: [
      { label: '餐饮', items: ['吃饭', '火锅', '烧烤', '自助餐', '聚餐', '外卖', '宵夜', '下午茶', '工作餐', '团建餐', '串串香', '麻辣烫', '冒菜', '烤鱼', '酸菜鱼', '小龙虾', '日料', '韩餐', '西餐', '炸鸡', '汉堡', '披萨', '面馆', '饺子', '包子', '粥', '米粉', '拉面', '馄饨', '螺蛳粉', '煲仔饭', '石锅拌饭'] },
      { label: '饮品', items: ['买水', '奶茶', '咖啡', '啤酒', '酒水', '果汁', '茶饮', '果茶', '柠檬茶', '奶盖茶', '气泡水', '精酿', '红酒', '鸡尾酒', '烧酒', '酸奶', '豆浆', '椰子水', '冰沙'] },
      { label: '娱乐', items: ['KTV', '电影票', '剧本杀', '桌游', '密室', '网费', '游戏币', '棋牌', '演出票', '唱歌', '电竞', '街机', '剧本', '脱口秀', '相声', '相声票', '音乐会', '展览', '漫展', '游乐场'] },
      { label: '运动', items: ['场地费', '教练费', '器材费', '球费', '健身卡', '更衣柜', '羽毛球', '篮球', '足球', '乒乓球', '网球', '高尔夫', '攀岩', '滑雪', '滑板', '冲浪', '拳击', '瑜伽', '普拉提', '跳绳', '武术', '射箭', '飞盘'] },
      { label: '交通', items: ['打车', '油费', '停车费', '过路费', '地铁', '公交', '高铁票', '机票', '火车票', '租车', '代驾', '拼车', '顺风车', '滴滴', '共享单车', '渡轮', '行李托运'] },
      { label: '住宿', items: ['房费', '民宿', '露营位', '酒店', '青旅', '帐篷', '度假村', '温泉酒店', '农家乐', '房车'] },
      { label: '购物', items: ['食材', '零食', '水果', '饮料', '装备', '日用品', '礼物', '酒水采购', '调料', '海鲜', '肉菜', '蔬菜', '甜品', '蛋糕', '面包', '水果拼盘', '烧烤食材', '火锅食材'] },
      { label: '其他', items: ['门票', '小费', '杂费', '押金', '快递费', '包间费', '服务费', '清洁费', '保险', '充电费', 'WiFi', '打印费', '包装费', '维修费', '洗衣费', '医疗费', '罚款', '红包', '份子钱'] }
    ],
    // 搜索
    expenseKeyword: '',
    ...
    filteredEditItems: [],
    // 热门推荐（默认展示的少量项目）
    hotExpenseItems: ['吃饭', '奶茶', '火锅', '打车', '烧烤', '啤酒', 'KTV', '零食', '房费', '场地费'],
    // 编辑弹窗
    editVisible: false,
    editExpenseId: '',
    editItemName: '',
